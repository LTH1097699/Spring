...
<body>
	<div class="main-content">
		<form:form action="${userURL}" id="formSubmit"
			method="get">
			<div class="main-content-inner">
				...
				<div class="page-header"> <h2 class="tm-block-title d-inline-block">Danh sách người dùng</h2></div>
				<!-- /.page-header -->
				<div class="row">
					<div class="row">
						<div class="col-xs-12">
								...
								<form action=""${userURL}" method="get">
									...
									<div class="pull-right tableTools-container">
										...
										<div class="dt-buttons btn-overlap btn-group">
											<!-- THEM THỂ LOẠI -->
											<c:url var="createURL" value="/admin/user/create" />
											<a flag="info"
												class="dt-button buttons-colvis btn btn-white btn-primary btn-bold"
												data-toggle="tooltip" title='Thêm tác giả'
												href='${createURL}'> <span> <i
													class="fa fa-plus-circle bigger-110 purple"> Thêm người dùng</i>
											</span>
											</a>											
										</div>
									</div>
											...
											<tbody>
												<c:forEach var="item" items="${model.listResult}">
													<tr>
														...
														<td>
                                                            <c:url var="UpdateURL" value="/admin/user/edit/${item.id}"/>
                                                           ...
                                                           <c:url var="deleteURL" value="/admin/user/delete/" />
                                                            ...
                                                            <a class="btn btn-sm btn-danger btn-edit delete-cart" data-id="${item.id}" data-toggle="tooltip" title="Xóa người dùng">
