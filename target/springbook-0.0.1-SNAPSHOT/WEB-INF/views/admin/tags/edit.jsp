			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-xs-12">
						...
						<c:url var="updateURL" value="/admin/tag/edit/${model.id}" />
						<form:form action="${updateURL}" class="form-horizontal" role="form" id="formSubmit" modelAttribute="model" method="POST">			
							...
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right"
									for="form-field-1"> Mã thẻ </label>
								<div class="col-sm-9">
									<form:input path="codeTag" type="text" cssClass="col-xs-10 col-sm-5" />
							...
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right"
									for="form-field-1"> Tên thẻ </label>
								<div class="col-sm-9">
									<form:input path="nameTag" type="text" class="col-xs-10 col-sm-5"/>
