...
<c:url var="saveURL" value="/admin/tag/create"/>
<html>
<head>
	...
	<div class="main-content">
		<div class="main-content-inner">
			...
			<div class="page-content">
				<div class="page-header">Thêm mới Tag</div>
				<!-- /.page-header -->
				<div class="row">
					<div class="col-xs-12">					
						...
						<form:form action="${saveURL}" class="form-horizontal" modelAttribute="model" method="post">							
							...
							<div class="clearfix form-actions"
								...
								<div class="col-md-offset-9 col-md-3 ">
									<a class="btn btn-danger text-white "
										href="<c:url value='/admin/tag/list?name=&page=1&limit=10' />"> <i
							...
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right"
									for="form-field-1"> Mã tag </label>
								<div class="col-sm-9">
									<form:input path="codeTag" cssClass="col-xs-10 col-sm-5" />
									<form:errors path="codeTag" style="color:red;" cssClass="error" />
								</div>
							</div>
							<!-- hinh anh -->
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right"
									for="form-field-1"> Tên Tag </label>
								<div class="col-sm-9">
									<form:input path="nameTag" cssClass="col-xs-10 col-sm-5" />
									<form:errors path="nameTag" style="color:red;" cssClass="error" />
								</div>
							</div>			
