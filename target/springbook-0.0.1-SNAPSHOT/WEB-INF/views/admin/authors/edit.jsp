			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-xs-12">
						...
						<c:url var="updateURL" value="/admin/author/edit/${model.id}" />
						<form:form action="${updateURL}" class="form-horizontal" role="form" id="formSubmit" modelAttribute="model" method="POST">
							...
							<div class="clearfix form-actions"
								...
								<div class="col-md-offset-9 col-md-3 ">
									<a class="btn btn-danger text-white "
										href="<c:url value="/admin/author/list?name=&page=1&limit=10" />"> <i
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<form:input path="codeAuthor" type="text" cssClass="col-xs-10 col-sm-5" />
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<form:input path="nameAuthor" type="text" class="col-xs-10 col-sm-5"/>
									<form:errors path="nameAuthor" style="color:red;"  cssClass="error" />
								</div>
							</div>
